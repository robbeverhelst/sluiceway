...
- **OpenTofu**, with stacks declared in `sluiceway.yaml`. A tick deploys the very plan file whose diff was approved ([`stacks[].tool`](docs/configuration.md#stackstool)).
