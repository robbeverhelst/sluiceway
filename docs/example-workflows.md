...
- **The version of the action.** The examples use `sluiceway/sluiceway@v0`, which starts to work with the first release, 0.1.0. Until then pin a full commit SHA of this repository in its place, all 40 characters.
