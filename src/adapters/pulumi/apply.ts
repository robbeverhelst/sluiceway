...
import type { ApplyResult, ToolContext } from "../adapter.ts";
...
function upCommand(name: string): string[] {
  return [
    "pulumi",
    "up",
    "--yes",
...
export async function apply(stack: Stack, context: ToolContext): Promise<ApplyResult> {
