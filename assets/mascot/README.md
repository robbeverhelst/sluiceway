...
Penny, the gate, standing mid-channel on a quay: upstream on the left, downstream on the right. Seventeen pictures, each light and dark, and fourteen of them once more with the destroy sign: 62 files. The dashboard header points at these files at the exact release tag.
